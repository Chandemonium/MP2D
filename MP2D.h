...
class MP2D {
 private:
  ...
  double a_one, a_two, rcut, width, s_8, userCos, userCss;
  double HFT, MP2_os, MP2_ss;
 ...
 public:
  ...
  void GetMP2DParameters(ifstream& infile);
  void GetSCSMP2DParameters(ifstream& infile);
  ...
  void ComputeEnergyandPrintResults();
